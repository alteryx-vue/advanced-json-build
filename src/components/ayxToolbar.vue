    ...
    <v-bottom-sheet>
      ...
      <v-card tile>
        <v-list two-line dark>
          ...
          <v-list-tile :href="displayUrl" target="_blank">
            <v-list-tile-avatar>
              ...
              <v-list-tile-content>
                ...
                <v-list-tile-sub-title>{{ displayUrl }}</v-list-tile-sub-title>
              </v-list-tile-content>
          </v-list-tile>
  ...
  export default {
    ...
    data () {
      return {
       ...
       displayUrl: this.$store.state.config.urls.display
      }
    },
    computed: {
      appTitle() {
        return this.$store.state.config.appTitle
      },
      updateAvail: {
        get () {
